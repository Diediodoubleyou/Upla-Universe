...
if (isset($_POST['producto_seleccionado'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        echo "No se encontraron registros para el producto seleccionado.";
    }
}
...
if (isset($_POST['borrar_registros'])) {
    ...
    if ($conn->query($sql) === TRUE) {
        echo "Los registros del producto $producto_seleccionado han sido borrados correctamente.";
        $producto_seleccionado = "";
        $valor = "";
    } else {
...
<body>
    ...
    <?php if (!empty($producto_seleccionado)) : ?>
        ...
        <form action="" method="post">
            <input type="hidden" name="producto_seleccionado" value="<?php echo $producto_seleccionado; ?>">
